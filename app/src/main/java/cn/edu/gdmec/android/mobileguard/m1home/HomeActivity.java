...
public class HomeActivity extends AppCompatActivity {
    ...
    private void showInterPswdDialog(){
        ...
        final InterPasswordDialog mInPwsdDialog=new InterPasswordDialog(HomeActivity.this);
        mInPwsdDialog.setCallBack(new InterPasswordDialog.MyCallBack(){
            @Override
            public void confirm(){
                if(TextUtils.isEmpty(mInPwsdDialog.getPassword())){
                    Toast.makeText(HomeActivity.this,"密码不能为空!",0).show();
                }else if(password.equals(MD5Utils.encode(mInPwsdDialog.getPassword()))){
                    mInPwsdDialog.dismiss();
        ...
        mInPwsdDialog.setCancelable(true);
        mInPwsdDialog.show();
    }
